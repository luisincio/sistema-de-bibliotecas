...
--
-- Servidor: localhost
-- Tiempo de generación: 08-10-2014 a las 09:44:46
...
INSERT INTO `materials` (`id`, `auto_cod`, `title`, `author`, `editorial`, `additional_materials`, `num_pages`, `edition`, `publication_year`, `isbn`, `subscription`, `material_type`, `thematic_area`, `shelve_id`, `purchase_order_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(21, 'CASO1412755386', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:06', '2014-10-08 13:03:06', NULL),
(22, 'CASO1412755387', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:06', '2014-10-08 13:03:06', NULL),
(23, 'CASO1412755388', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(24, 'CASO1412755389', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(25, 'CASO1412755390', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(26, 'CASO1412755391', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(27, 'CASO1412755392', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(28, 'CASO1412755393', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(29, 'CASO1412755394', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:07', '2014-10-08 13:03:07', NULL),
(30, 'CASO1412755395', 'Cien años de soledad', 'Gabriel García Márquez', 'tavo', 'CD', '200', '10', 1990, '123456789012', NULL, 1, 1, 1, 1, '2014-10-08 13:03:08', '2014-10-08 13:03:08', NULL);
...
(1, '00000000', '$2y$10$Yykqe6lOymhq9uexRq1Ic.Lj0yYlUN9jUVf4t2kGJ81stffuvn9i.', 'super', 'admin', 'superadmin@host.com', NULL, 'M', NULL, 1, NULL, NULL, 1, 'vtg01QZaWjzuekW47ZOEJCIrHcqzJFhXDUzhMEHmb3YPaPeCfy0lXozyykUM', NULL, '2014-10-01 05:00:00', '2014-10-08 11:47:51', NULL),
(2, '47029368', '$2y$10$wQQL2H//6FmBDXxI6fgOTe5gVjcWBb46oolhJQulY7dXoZGHL/WbO', 'Eduardo Antonio', 'Merino Tejada', 'eduardo.merino@gmail.com', 'Av. Siempre Viva 742', 'M', '123-4567', 1, 'Peruano', 1, 2, 'Q5kOAurU3dXTPn68Nwquxosf0FnrIyyF2kwtxYjafsQTwkHM6BIcIMB9o2fT', NULL, '2014-10-02 05:00:00', '2014-10-06 10:00:34', NULL),
...
(2, 'Profesor', 'Perfil de un profesor o catedrático', 4, '6', '2014-10-02 05:00:00', NULL, NULL);
...
--
ALTER TABLE `loans`
  ADD CONSTRAINT `loansXmaterial` FOREIGN KEY (`material_id`) REFERENCES `materials` (`id`),
...
ALTER TABLE `material_reservations`
  ADD CONSTRAINT `material_reservationXmaterial` FOREIGN KEY (`material_id`) REFERENCES `materials` (`id`),
