...
--
-- Servidor: localhost
-- Tiempo de generación: 07-10-2014 a las 20:27:17
...
CREATE TABLE IF NOT EXISTS `materials` (
  ...
  `subject_area` varchar(45) DEFAULT NULL,
  ...
  `details_purchase_order_id` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `materialXdetails_idx` (`details_purchase_order_id`),
...
(1, '00000000', '$2y$10$Yykqe6lOymhq9uexRq1Ic.Lj0yYlUN9jUVf4t2kGJ81stffuvn9i.', 'super', 'admin', 'superadmin@host.com', NULL, 'M', NULL, 1, NULL, NULL, 1, 'kes6WIatHz5olLzL6FNlQ1ECXcnm6rPr4qDMNmce3N6AaQbfdOq9Y5TH4f9c', NULL, '2014-10-01 05:00:00', '2014-10-06 10:56:18', NULL),
...
ALTER TABLE `materials`
  ADD CONSTRAINT `materialXdetail_purchase_order` FOREIGN KEY (`details_purchase_order_id`) REFERENCES `details_purchase_orders` (`id`),
