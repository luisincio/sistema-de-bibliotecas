@extends('templates/catalogTemplate')
@section('content')
	...
	@endif
		{{ Form::open(array('url'=>'catalog/submit_catalog','method'=>'get' ,'role'=>'form', 'id'=>'search-form','class' => 'form-inline')) }}
			...
			@if($materials)
				...
				<tr>
					...
					<td class="reservation">
						@if($user && !$user->restricted_until)
							{{ HTML::link('','Reservar',array('class'=>'btn btn-success reservation-button','data-code'=>$material->base_cod,'data-branch'=>$material->branch_id,'data-shelf'=>$material->shelve_id)) }}
						@endif
					</td>
				</tr>
				@endforeach
